...
pub fn generate_web_js(target: &TargetIr) -> String {
    ...
    out.push_str("      btn.style.margin = '4px 8px 4px 0';\n");
    out.push_str("      btn.style.padding = '6px 10px';\n");
    out.push_str("      btn.style.border = '1px solid #00ffff';\n");
    out.push_str("      btn.style.background = '#001826';\n");
    out.push_str("      btn.style.color = '#ffffff';\n");
    out.push_str("      btn.style.cursor = 'pointer';\n");
    ...
    out.push_str("      });\n");
    out.push_str("      root.appendChild(btn);\n");
    out.push_str("      continue;\n");
    out.push_str("    }\n");
    out.push_str("    let el;\n");
    out.push_str("    if (kind === 'heading') {\n");
    out.push_str("      el = document.createElement('h2');\n");
    out.push_str("    } else if (kind === 'input') {\n");
    out.push_str("      el = document.createElement('input');\n");
    out.push_str("      el.value = item.text || '';\n");
    out.push_str("      el.addEventListener('keydown', (e) => {\n");
    ...
    out.push_str("        }\n");
    out.push_str("      });\n");
    out.push_str("    } else if (kind === 'textarea') {\n");
    out.push_str("      el = document.createElement('textarea');\n");
    out.push_str("      el.textContent = item.text || '';\n");
    out.push_str("    } else if (kind === 'list') {\n");
    out.push_str("      el = document.createElement('div');\n");
    out.push_str("      el.textContent = `• ${item.text || ''}`;\n");
    out.push_str("    } else if (kind === 'badge' || kind === 'toast' || kind === 'banner') {\n");
    out.push_str("      el = document.createElement('strong');\n");
    out.push_str("      el.textContent = item.text || '';\n");
    out.push_str("    } else {\n");
    out.push_str("      el = document.createElement('div');\n");
    out.push_str("      el.textContent = item.text || '';\n");
    out.push_str("    }\n");
    out.push_str("    if (item.color) el.style.color = item.color;\n");
    out.push_str("    if (item.css && typeof item.css === 'object') Object.assign(el.style, item.css);\n");
    out.push_str("    root.appendChild(el);\n");
    out.push_str("  }\n");
    out.push_str("}\n\n");
