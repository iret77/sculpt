...
// Avoids the need for @types/node by declaring the global 'process' object and 'require' function.
declare const process: any;
declare function require(name: string): any;

// Use require instead of import to avoid @types/node dependency
